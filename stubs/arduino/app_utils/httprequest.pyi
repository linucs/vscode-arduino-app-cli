...
class HttpClient:
    ...
    """
    def __init__(self, total_retries: int = 5, backoff_factor: int = 1, status_forcelist: frozenset = (411, 500, 502, 503, 504), allowed_methods: frozenset = ...) -> None: ...
    def request_with_retry(self, url: str, method: str = 'GET', data: dict | str = None, json: dict = None, headers: dict = None, timeout: int = 5):
